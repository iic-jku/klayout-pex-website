...
::: {.callout-note}
Normally, devices with SPICE simulation models (e.g. like MOM-capacitors[^1] in the sky130A PDK) are ignored ("blackboxed") during parasitic extraction.
