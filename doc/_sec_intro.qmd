...
::: {.callout-tip}
KPEX *tool* source code itself is made publicly available on GitHub ([follow this link](https://github.com/iic-jku/klayout-pex)) and shared under the GPL-3.0 license.

KPEX *documentation* source code is made publicly available on GitHub ([follow this link](https://github.com/iic-jku/klayout-pex-website)) and shared under the Apache-2.0 license.
...
- [MAGIC](https://opencircuitdesign.com/magic/)-wrapper engine:
  ...
  - `MAGIC 8.3.679` or newer is required: older revisions report twice the sidewall capacitance (see @sec-magic-cap-types-sidewall-capacitance and <https://github.com/martinjankoehler/magic/issues/6#issuecomment-5371056429>)
